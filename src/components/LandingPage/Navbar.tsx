...
export default function Navbar() {
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 px-8 py-4 shadow-white/40 rounded-b-full hover:py-6 hover:px-12 transition-all duration-500 font-bold">
