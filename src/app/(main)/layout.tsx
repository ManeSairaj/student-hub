...
export default function MainLayout({
  ...
  return (
    <div className="min-h-screen w-screen max-w-full text-foreground antialiased bg-gradient-to-b from-background via-background/90 to-background">
      <Navbar />
      <div className="flex flex-col lg:flex-row relative z-10 max-w-full">
        ...
        <div className="flex w-full max-w-full min-h-full overflow-x-hidden px-2 lg:px-2">
          {loading ? (
